...
def generate_launch_description():
    parameters = json.loads('{"joint":"6930f590e1c9963d56d36de2","control_mode":"position","limit.lower_position":0,"limit.upper_position":360,"limit.position_step":1,"limit.max_effort":10,"limit.effort_step":null,"limit.max_velocity":35,"limit.velocity_step":0}')
    ...
    env = {
        "POLYFLOW_NODE_ID": "6930f89ee1c9963d56d36e4a",
    ...
    return LaunchDescription(
        [
            ExecuteProcess(
                cmd=["python3", "workspace/src/6930f89ee1c9963d56d36e4a/odrive-s1/node.py"],
                additional_env=env,
                output="screen",
            )
        ]
