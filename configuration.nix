...
let
  user      = "admin";
  password  = "password";
  hostname  = "6930f4a1e1c9963d56d36dc2";
  homeDir   = "/home/${user}";
  ...
  nixosRebuildRunner = pkgs.writeShellApplication {
    ...
    text = ''
      ...
      # Service already runs as root; avoid sudo to prevent interactive auth failures.
      exec nixos-rebuild switch --flake "$FLAKE_REF" --accept-flake-config
    '';
  };
